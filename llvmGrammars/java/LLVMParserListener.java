...
public interface LLVMParserListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link LLVMParser#mySingleInstruction}.
	 * @param ctx the parse tree
	 */
	void enterMySingleInstruction(LLVMParser.MySingleInstructionContext ctx);
	/**
	 * Exit a parse tree produced by {@link LLVMParser#mySingleInstruction}.
	 * @param ctx the parse tree
	 */
	void exitMySingleInstruction(LLVMParser.MySingleInstructionContext ctx);
	/**
